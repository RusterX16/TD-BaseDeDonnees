...
SELECT DISTINCT r.np FROM Reap r JOIN Reap r2 ON r.nf LIKE r2.nf WHERE r.np != r2.np;

-- Question 4.3.7

SELECT r.np FROM Reap r JOIN Reap r2 ON r.date_reap LIKE r2.date_reap WHERE r.np != r2.np AND r.nf != r2.nf AND r.qr > 50;
